...
export const ExamModeModal = () => {
  ...
  const [selectedMode, setSelectedMode] = useState<"practice" | "real-time" | null>(null);
  ...
  const examIsActive = useMemo(() => {
    ...
    return isTimeActive({validFrom: activeExamMode.validFrom, validTill: activeExamMode.validTill});
  }, [activeExamMode?.exam]);
            ...
            <>
              ...
              <div className="flex flex-col gap-2 w-full my-4">
                ...
                <div className="flex flex-col sm:flex-row justify-between w-full gap-1">
                  ...
                  <span className="font-light text-sm">{examData.category}</span>
                </div>
                <div className="flex flex-col sm:flex-row justify-between w-full gap-1">
                ...
                <div className="flex flex-col sm:flex-row justify-between w-full gap-1">
                  ...
                  <span className="font-light text-sm">
                    {"subjects" in examData && Array.isArray((examData as any).subjects)
                  ...
                  <p>
                    <b>Note:</b> The minimum time allowed for this exam is <b>10 minutes</b>. The maximum is <b>{examData.duration} minutes</b>.
                  </p>
                </div>
            ...
            <>
              <AlertDialogHeader>
                <div className="flex flex-col items-center gap-2">
                  ...
                  <h1 className="text-base sm:text-lg font-semibold">Exam Information</h1>
                </div>
                <AlertDialogDescription className="text-center mt-2 text-xs sm:text-sm">
                  <span className="font-medium">Practice mode</span> allows you to set a custom duration.<br />
                  <span className="font-medium">Real-time mode</span> uses the default exam duration.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 my-4">
                ...
                >
                  ...
                  <span className="font-semibold text-sm sm:text-base">Practice Demo</span>
                </div>
                <div
                  className={cn(
                    "px-4 py-5 rounded-2xl flex flex-col items-center justify-center cursor-pointer w-full max-w-[150px] border transition-all",
                ...
                >
                  ...
                  <span className="font-semibold text-sm sm:text-base">Start Exam</span>
                </div>
              </div>
              {error && (
