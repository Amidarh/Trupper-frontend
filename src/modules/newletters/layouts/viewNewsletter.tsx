  ...
  useEffect(() => {
    if (singleNewsletter && categories) {
      reset({
        ...
        subCategory: singleNewsletter.subCategory
          ? singleNewsletter.subCategory.id
          : '',
        userCategory: singleNewsletter.category
          ? singleNewsletter.category.id
          : '',
      ...
      if (singleNewsletter.category) {
        setSelectedCategory(
          categories.find(
            (category) => category.id === singleNewsletter.category.id
          )
        );
        getSubCategoryByCategory(singleNewsletter.category.id);
        setSelectedSubCategory(
          subCategory?.find(
            (category) => category.id === singleNewsletter.subCategory.id
          )
        );
      }
      setSelectedUserType(
        newsletterUserType.find(
          (userType) => userType.key === singleNewsletter.userType
        )
      );
    }
