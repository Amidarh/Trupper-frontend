...
export default function Hero() {
  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-100 to-gray-900'>
      ...
      <div className='relative z-10 text-center px-5 max-w-6xl mx-auto mt-40'>
        <div className='space-y-8 animate-fade-in'>
          {/* Badge */}
          <div className='inline-flex items-center px-4 py-2 rounded-full bg-gray-900/10 backdrop-blur-sm border border-gray-900/20 animate-fade-in-up'>
            <span className='w-2 h-2 bg-gray-900 rounded-full mr-2 animate-pulse'></span>
            <span className='text-sm text-gray-900/90 font-medium'>
              Empowering Education Worldwide
            </span>
          </div>

          {/* Main heading */}
          <h1 className='text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-gray-900 leading-tight animate-fade-in-up'>
            ...
            <span className='block bg-gradient-to-r from-gray-100 via-gray-900 to-gray-100 bg-clip-text text-transparent text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mt-2'>
              for Schools
            </span>
            <span className='block bg-gradient-to-r from-gray-900 via-gray-100 to-gray-900 bg-clip-text text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-2'>
              at Every Level
            </span>
          </h1>

          {/* Description */}
          <p className='text-xl md:text-2xl text-gray-900/90 max-w-4xl mx-auto leading-relaxed animate-fade-in-up'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center items-center pt-8 animate-fade-in-up mb-30'>
            <Button
              ...
              className='group relative px-8 py-4 text-lg font-semibold rounded-full bg-gradient-to-r from-gray-900 to-gray-100 hover:from-gray-800 hover:to-gray-200 text-gray-900 transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-gray-900/25 animate-pulse'
            >
