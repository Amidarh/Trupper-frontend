...
export const Settings = () => {
  ...
  useEffect(() => {
    if (organization) {
      ...
      setSelectedCategory(
        categories?.find(
          (category) => category.id === organization.defaultCategory
        )
      );
      getSubCategoryByCategory(organization.defaultCategory);
      setSelectedSubCategory(
        subCategory?.find(
          (category) => category.id === organization.defaultSubCategory
        )
      );
    }
  }, []);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      {enableSignup && (
        <>
          <h1 className='text-semibold text-gray-900 dark:text-gray-300'>
            Sign up Settings
          </h1>
          <div className='flex flex-row items-center gap-4 mt-2'>
                ...
                <div>
                  ...
                  <Select
                    onValueChange={(value) => {
                      ...
                      setValue('defaultCategory', value, {
                        shouldValidate: true,
                      });
                  ...
                  {errors.defaultCategory && (
                    <p className='text-red-500 text-sm mt-1'>
                      {errors.defaultCategory.message}
                    </p>
                  )}
                </div>
                <div>
                  ...
                  <Select
                    onValueChange={(value) => {
                      ...
                      setValue('defaultSubCategory', value, {
                        shouldValidate: true,
                      });
                    }}
                  ...
                  {errors.defaultSubCategory && (
                    <p className='text-red-500 text-sm mt-1'>
                      {errors.defaultSubCategory.message}
                    </p>
                  )}
                </div>
              </main>
