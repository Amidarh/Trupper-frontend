...
export function ViewExamCategoryModal({
  category,
}: {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <div
          key={category.id}
          className={`flex justify-center items-center ${category.status ? 'text-green-900 bg-green-200' : 'text-red-900 bg-red-200'} px-4 py-2 text-sm  rounded-xl cursor-pointer hover:px-3.5 hover:py-1.5 duration-500`}
        >
          {category.name}
        </div>
      </AlertDialogTrigger>
