...
export const PreferenceSettings = () => {
    return (
        <section>
            ...
            <main 
                className="grid sm:grid-cols-2 grid-cols-1 gap-5 mt-5"
            >
                <div className="mb-4">
                    <Label htmlFor="email" className="mb-2">First Name</Label>
                    <Input type="text" id="email" placeholder="Enter First Name" className="h-12" />
                </div>
                <div className="mb-4">
                    <Label htmlFor="email" className="mb-2">Last Name</Label>
                    <Input type="text" id="email" placeholder="Enter Last Name" className="h-12" />
                </div>
            </main>
        </section>
    )
