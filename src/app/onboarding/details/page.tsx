            ...
            <main className=" py-1 w-full flex flex-row gap-2">
                <section className="w-full lg:max-w-xl">
                    ...
                    <form onSubmit={handleSubmit(organizationDetails)}>
                        ...
                        <div className="mt-4">
                            <Label htmlFor="user range" className="mb-1">Your user range</Label>
                            <Select
                            onValueChange={(value) => {
                            ...
                            {errors.usersRange && <p className="text-red-500 text-sm mt-1">{errors.usersRange.message}</p>}
                        </div>

                        <div className="mt-4">
                            <Label htmlFor="user range" className="mb-1">Your staff range</Label>
                            <Select
                            onValueChange={(value) => {
                            ...
                            {errors.staffRange && <p className="text-red-500 text-sm mt-1">{errors.staffRange.message}</p>}
                        </div>

                        <Button className="mt-5" type="submit" disabled={isSubmitting}>{isSubmitting ? "Loading..." : "Finish"}</Button>
                    </form>
                </section>
