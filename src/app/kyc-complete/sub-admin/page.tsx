        ...
        <ScrollArea className="w-full">
            <div className="flex pt-10 sm:items-center justify-center pb-12 w-full">
                <Card className="w-full max-w-120 p-2 max-sm:bg-transparent border-none sm:border sm:p-8">
                    ...
                    <form  onSubmit={handleSubmit(kycComplete)}>
                        <div className="mb-4">
                        ...
                        <div className="mt-6">
                            {kycDetailsLoading ? <Button type="submit" className="w-full cursor-pointer h-10">
                                Getting Data
                            </Button> : <Button type="submit" className="w-full cursor-pointer h-10">
