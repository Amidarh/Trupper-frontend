...
const AdminDetailPage = () => {
    const { getASingleAdmin, singleAdmin, singleAdminLoading } = useAdminService();
    useEffect(() => {
        getASingleAdmin();
    }, [])
    return (
        <DashboardLayout
            pageTitle={singleAdminLoading ? "Getting Data" : `${singleAdmin?.firstName} ${singleAdmin?.lastName}`}
