          ...
          <div className="flex justify-start flex-col w-fit items-start">
            {edit ? (
              ...
              <div className="relative h-24 w-24 border rounded-sm">
                <Image
                  src={typeof singleExam?.image === "string" ? singleExam.image : ""}
            ...
            <div>
              ...
              >
                <SelectTrigger className="w-full h-12" id="examType">
                  <SelectValue
                    placeholder={
                      examTypeLoading ? "Loading..." : singleExam?.examType?.name || "Select Exam Type"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              >
                <SelectTrigger className="w-full h-12" id="duration">
                  <SelectValue
                    placeholder={
                      examTypeLoading ? "Loading..." : singleExam?.duration || "Select Exam Duration"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
