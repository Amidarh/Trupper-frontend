  ...
  const onSubmit = useCallback(
    async (data: ExamFormData) => {
      try {
        ...
        formData.append("subjectToBeWritten", data.subjectToBeWritten.toString());
      ...
      <Card className="p-4 mb-4">
        ...
        <form id="examForm" onSubmit={handleSubmit(onSubmit)}>
          ...
          <main className="grid sm:grid-cols-2 grid-cols-1 gap-5">
            ...
            <div className="mb-4">
              <Label htmlFor="acronym" className="mb-2">Acronym</Label>
              <Input
                type="text"
                id="acronym"
            ...
            <div>
              <Label htmlFor="examType" className="mb-2">Exam Type</Label>
              <Select
                onValueChange={(value) => {
            ...
            <div>
              <Label htmlFor="duration" className="mb-2">Exam Duration</Label>
              <Select
                onValueChange={(value) => {
            ...
            <div className="mb-4">
              ...
              <Input
                ...
                className="h-12"
                {...register("subjectToBeWritten", { valueAsNumber: true,
                   validate: (value) => Number.isInteger(value) || "Must be an integer"
                 })}
              />
              {errors.subjectToBeWritten && (
                <p className="text-red-500 text-sm mt-1">{errors.subjectToBeWritten.message}</p>
              )}
            </div>
            <div className="mb-4">
              <Label htmlFor="noOfQuestions" className="mb-2">No. of Questions Per Exam</Label>
              <Input
                type="number"
                id="noOfQuestions"
              ...
              {errors.noOfQuestions && (
                <p className="text-red-500 text-sm mt-1">{errors.noOfQuestions.message}</p>
              )}
            </div>
            <div className="mb-4">
              <Label htmlFor="maxNoOfSubjects" className="mb-2">Max No. of Subjects</Label>
              <Input
                type="number"
                id="maxNoOfSubjects"
                placeholder="Enter Max No. of Subjects"
                className="h-12"
                {...register("maxNoOfSubjects", { valueAsNumber: true,
                   validate: (value) => Number.isInteger(value) || "Must be an integer"
                 })}
              />
              {errors.maxNoOfSubjects && (
                <p className="text-red-500 text-sm mt-1">{errors.maxNoOfSubjects.message}</p>
              )}
            </div>
            <div className="mb-4">
              <Label htmlFor="minNoOfSubjects" className="mb-2">Min No. of Subjects</Label>
              <Input
                type="number"
                id="minNoOfSubjects"
                placeholder="Enter Min No. of Subjects"
                className="h-12"
                {...register("minNoOfSubjects", { valueAsNumber: true,
                   validate: (value) => Number.isInteger(value) || "Must be an integer"
                 })}
              />
              {errors.minNoOfSubjects && (
                <p className="text-red-500 text-sm mt-1">{errors.minNoOfSubjects.message}</p>
              )}
            </div>
            <div className="mb-4">
              <Label htmlFor="scoreMultiplier" className="mb-2">Score Multiplier</Label>
              <Input
                type="number"
                id="scoreMultiplier"
              ...
              {errors.scoreMultiplier && (
                <p className="text-red-500 text-sm mt-1">{errors.scoreMultiplier.message}</p>
              )}
            </div>
          </main>
          <Separator className="my-5" />
